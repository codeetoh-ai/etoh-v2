...
export default function NewsPage() {
    ...
    const featuredArticle = Array.isArray(articles) ? articles.find(a => a.articleType === 'featured') : null
    ...
    const clinicalPerspectives = nonFeatured.filter(a => a.articleType === 'clinical_perspective')
    const systemIntelligence = nonFeatured.filter(a => a.articleType === 'system_intelligence')
                    ...
                    <div style={{ maxWidth: 1280, margin: '0 auto', display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'flex-start', gap: isMobile ? 24 : 64 }}>
                        ...
                        >
                            <p style={{ margin: 0, color: '#43474F', fontSize: 18, fontFamily: 'Inter', fontWeight: 400, lineHeight: '30px' }}>
                                ETOH runs inside some of the most complex clinical environments in the country. This is where we share what that produces.
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div style={{ padding: isMobile ? '32px 16px 64px' : '48px 24px 80px' }}>
                    <div style={{ maxWidth: 1280, margin: '0 auto' }}>
                        <motion.div
                            ...
                            style={{ paddingBottom: 16, borderBottom: '1px rgba(196, 198, 208, 0.20) solid', display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}
                        >
                            <span style={{ color: '#001736', fontSize: 28, fontFamily: 'Manrope', fontWeight: 800, lineHeight: '36px' }}>CLINICAL PERSPECTIVES</span>
                        </motion.div>
                        <p style={{ marginTop: 24, color: '#43474F', fontSize: 18, fontFamily: 'Inter', lineHeight: '30px' }}>
                            ETOH's clinical advisors, deployed facility leadership, and research partners write about AI in clinical settings, the operational design of healthcare delivery, and the realities of running hospitals under real‑world conditions. The people writing here run clinical systems.
                        </p>
                    </div>
                </div>
                ...
                <div style={{ padding: isMobile ? '32px 16px 64px' : '48px 24px 80px' }}>
                    <div style={{ maxWidth: 1280, margin: '0 auto' }}>
                        <motion.div
                            ...
                            style={{ paddingBottom: 16, borderBottom: '1px rgba(196, 198, 208, 0.20) solid', display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}
                        >
                            <span style={{ color: '#001736', fontSize: 28, fontFamily: 'Manrope', fontWeight: 800, lineHeight: '36px' }}>SYSTEM INTELLIGENCE</span>
                        </motion.div>
                        <p style={{ marginTop: 24, color: '#43474F', fontSize: 18, fontFamily: 'Inter', lineHeight: '30px' }}>
                            Operational patterns observed across deployed facilities — anonymised, consented, and published because the field benefits from honest data about how hospitals function, where care coordination breaks down, and what platform‑level interventions demonstrably change outcomes.
                        </p>
                    </div>
                </div>

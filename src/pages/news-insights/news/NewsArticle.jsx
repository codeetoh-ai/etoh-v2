...
.article-related-card:hover .related-card-title {
            ...
            <PageLayout fullWidth title="" lightHero>
                ...
                <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
                        ...
                        <span style={{ color: '#43474F', fontSize: 14, fontFamily: 'Inter', fontWeight: 500 }}>Loading article…</span>
                    </div>
            ...
            <PageLayout fullWidth title="" lightHero>
                ...
                <div style={{ minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 24, padding: '48px 24px' }}>
                    ...
                    <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', gap: 8 }}>
                        <h1 style={{ margin: 0, color: '#001736', fontSize: 28, fontFamily: 'Manrope', fontWeight: 800 }}>Article Not Found</h1>
                        <p style={{ margin: 0, color: '#43474F', fontSize: 15, fontFamily: 'Inter', lineHeight: '24px' }}>
                            The article you're looking for doesn't exist or may have been removed.
                        </p>
                    </div>
                    <button
                        onClick={() => navigate('/news-insights/news')}
    ...
    return (
        <PageLayout fullWidth title="" lightHero>
            ...
            <div style={{ padding: isMobile ? '72px 16px 0' : '88px 40px 0', maxWidth: 1280, margin: '0 auto' }}>
                ...
                >
                    <Link to="/news-insights/news" className="article-back-btn">
                        ...
                        <span style={{ fontSize: 13, fontFamily: 'Inter', fontWeight: 600 }}>Back to News</span>
                    </Link>
                </motion.div>
            </div>
                                    ...
                                    {article.sidebar.items.map((item, i) => (
                                        <div
                                            ...
                                            style={{
                                                paddingTop: i > 0 ? 18 : 0,
                                                paddingBottom: 18,
                                                borderBottom: i < article.sidebar.items.length - 1 ? '1px solid #F3F4F5' : 'none',
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : `repeat(${Math.min(related.length, 3)}, 1fr)`, gap: isMobile ? 28 : 24 }}>
                            {related.slice(0, 3).map((rel, i) => (
                                ...
                                >
                                    ...
                                    {/* Meta */}
                                    <span style={{ color: '#006970', fontSize: 10, fontFamily: 'Inter', fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1.4, display: 'block', marginBottom: 10 }}>
                                        {rel.category}
                                    </span>

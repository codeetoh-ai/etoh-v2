...
const headingLines = [
    'Evidence—The record of',
    'what ETOH changes and',
    'what it has not yet changed.',
]
                    ...
                    <div style={{ maxWidth: 1216, marginLeft: 'auto', marginRight: 'auto' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'flex-start', gap: isMobile ? 32 : 72, marginBottom: isMobile ? 64 : 128 }}>
                            ...
                            <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 24 }}>
                                ...
                                >
                                    We build clinical evidence prospectively, in real deployment settings, against outcome measures that reflect actual clinical value — diagnostic cycle times, care pathway adherence, avoidable adverse events, and patient-reported experience across the full episode of care. We calibrate our research agenda to produce accurate results, because accurate results are the only foundation on which a clinical platform can be responsibly scaled.
                                </p>
                            </div>

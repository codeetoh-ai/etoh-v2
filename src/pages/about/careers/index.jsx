    ...
    return (
        <PageLayout title="Careers" fullWidth={true}>
            ...
            <div style={{
                ...
                {!isMobile && (
                    <div style={{
                        ...
                        <div style={{ alignSelf: 'stretch', height: 738, position: 'relative', overflow: 'hidden' }}>
                            <div style={{ width: 640, height: 320, left: 0, top: 209, position: 'absolute', outline: '0.64px #001736 solid', outlineOffset: '-0.32px' }} />
                            <div style={{ width: 640, height: 320, left: 0, top: 273, position: 'absolute', outline: '0.64px #001736 solid', outlineOffset: '-0.32px' }} />
                        </div>
                    </div>
                )}
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <span style={{ color: '#001736' }}>Building the Infrastructure of </span>
                        <span style={{ color: '#006970' }}>Modern Healthcare</span>
                        <span style={{ color: '#001736' }}>.</span>
                    </div>
            ...
            <div style={{
                ...
                <div style={{ width: '100%', maxWidth: 1280, marginLeft: 'auto', marginRight: 'auto', display: 'flex', flexDirection: 'column', gap: 0 }}>

                    {/* Top row: Mission card + Culture card */}
                    ...
                    {/* Bottom row: Image + two value columns */}
                    <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'stretch' }}>
                        ...
                        {/* Right: Clinical Precision + Operational Autonomy */}
                        <div style={{
